          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                Founded in 2020, ShopHub began as a small startup with a big vision: to create an online marketplace
                that puts customers first. What started as a team of five passionate individuals has grown into a
                thriving platform serving millions of customers worldwide.
              </p>
              <p className="text-gray-600 mb-4">
                We believe that shopping online should be simple, secure, and enjoyable. That's why we've built our
                platform with cutting-edge technology and a customer-centric approach that ensures every interaction is
                smooth and satisfying.
              </p>
              <p className="text-gray-600">
                Today, we're proud to partner with thousands of sellers and brands to bring you the best products at
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                We carefully curate our product selection to ensure every item meets our high standards for quality and
                value.
              </p>
            </div>
            <div className="text-center p-6">
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                We use advanced security measures to protect your data and ensure safe, secure transactions every time.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              We're more than just an online store - we're your trusted shopping partner
            </p>
          </div>
